module DEGICA
  module CONVERT
    ...
    LOGGING = false # only useful for debugging this script
    LOGSCRIPTS = true # lists any damage formulae, and event commands using scripts
    LOGCOMMENTS = false # only turn this on if you have scripts that look for certain comments and want to re-implement them
